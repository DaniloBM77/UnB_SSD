...
O estudo foi inspirado em conceitos de análise de dados e Controle Estatístico de Processo (CEP), buscando compreender padrões e variabilidade no consumo energético.
...
* **Entrada (X):** características das edificações
* **Saída (Y):** consumo energético
